...
@push('admin-css')
    <title>Admin | User Information Show</title>
...
@section('admin-content')
    <section class="section">
        <div class="section-header">
            <h1>User Information Show</h1>
        </div>

        <div class="card card-primary">
            <div class="card-header">
                <h4>User Information Show</h4>
                {{-- <div class="card-header-action">
                    <a href="{{ route('admin.show-contact-message.create') }}" class="btn btn-primary">Create new</a>
                </div> --}}
            </div>
            <div class="card-body">
                {{ $dataTable->table() }}
